 ...
 * <p>
 * 类名统一以 {@code UtilExt} 结尾，与底层 {@code com.alibaba.fastjson2.JSON} 明确区分。
 * <p>
 ...
 * @version 0.0.1
 */
public final class JsonUtilExt {
    ...
    /** 批量写入 Map 中的所有键值对。 */
    public static JSONObject putAll(JSONObject target, Map<String, Object> map) {
