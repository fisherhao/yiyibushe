...
/**
 * AI 技能持久化对象（PO），与 ai_skill 表一条记录对应。技能是声明式业务 SOP。
 *
...
public class SkillPO implements Serializable {
    ...
    private static final long serialVersionUID = 4004004004004004004L;
    ...
    /** 工具引用 JSON 原文：[{"toolId":...,"required":true,"order":1}] */
    ...
    /**
     * 获取触发/不触发 few-shot 注释
     *
     * @return 触发/不触发 few-shot 注释
     */
